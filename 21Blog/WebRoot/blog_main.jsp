		  ...
		  <br>		  <table width="398" height="374" border="0" cellpadding="0" cellspacing="0" background="images/f_main.gif">
            ...
            <tr>
			  ...
			  <table width="371" height="70" border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="371"> <font color="A1882E">欢迎进入狼族博客地带，在这里您可以尽情抒发您的情感。<br>
        ...
        <tr align="center">
          <td height="152" valign="top"><br>
            ...
            <table width="103" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr align="center">
                <td height="30" background="images/f_certer.gif"><a href="articleInfo_f_article_query.htm?id=<s:property value="#articleCommend.id"/>" target="_blank"><s:property value="#articleCommend.title"/></td>
              </tr>
              </s:iterator>
			   <tr>
	      <td><img src="images/f_down.gif"></td>
          ...
          <td width="160" valign="top"><br>
            ...
            <table width="103" border="0" cellspacing="0" cellpadding="0">
			   ...
			   <tr>
	             <td><img src="images/f_hot_article.gif"></td>
	           </tr>
			
              <s:iterator value="%{#request.articleVistor}" id="articleVistor">
              <tr align="center">
                <td height="30" background="images/f_certer.gif"><a href="articleInfo_f_article_query.htm?id=<s:property value="#articleVistor.id"/>" target="_blank"><s:property value="#articleVistor.title"/></td>
              </tr>
              </s:iterator>
			   <tr>
	      <td><img src="images/f_down.gif"></td>
