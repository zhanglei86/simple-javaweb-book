	...
	<s:bean name="org.apache.struts2.util.Counter" id="counter">
	    ...
	    <s:iterator status="st" id="idd">
	     <s:if test="%{#request.account==null}">
	      <s:a href="articleInfo_admin_articleQuery.htm?count=%{idd}"><s:property id="counter"/></s:a>
	    </s:if>
	    <s:else>
	     <s:a href="articleInfo_admin_articleQuery.htm?count=%{idd}&account=%{#request.account}"><s:property id="counter"/></s:a>
	    </s:else>
	      <s:if test="!#st.last">
	      &nbsp;&nbsp;&nbsp;
	      </s:if>
