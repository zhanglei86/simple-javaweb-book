...
<jsp:directive.page import="com.wy.dao.ObjectDao"/>
<jsp:directive.page import="com.wy.model.ArticleInfo"/>
<jsp:directive.page import="java.util.List"/>
<jsp:directive.page import="com.wy.tools.ToChinese"/>
<%
  ...
  <tr>
    ...
    <s:bean name="org.apache.struts2.util.Counter" id="counter">
	    ...
	    <s:if test="%{#request.type==null}">
	      <s:a href="userInfo_goinUser.htm?account=%{#request.userInfo.account}&count=%{id}"><s:property id="counter"/></s:a>
	    </s:if>
	    <s:else>
	     <s:a href="userInfo_goinUser.htm?account=%{#request.userInfo.account}&count=%{id}&type=%{#request.type}"><s:property id="counter"/></s:a>
	    </s:else>
	      <s:if test="!#st.last">
	      &nbsp;&nbsp;&nbsp;
	      </s:if>
