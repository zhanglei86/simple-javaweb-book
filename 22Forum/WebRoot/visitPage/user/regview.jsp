...
<form action="<%=contextPath%>/regrun" name="regform" method="post">
...
<table border="0" width="100%" style="word-break:break-all" cellpadding="3" cellspacing="1" bgcolor="#8A8989">
	...
	<tr bgcolor="white" height="20">
		...
		<td>
			...
			<input type="button" name="checknamesubmit" value="检查该会员名称" onclick="mycheckexistsubmit('<%=contextPath%>/checkmember')">
	...
	<tr bgcolor="lightgrey">
		<td colspan="2" align="center">
			<input type="button" name="regsubmitb" value="注册会员" onclick="myaddusersubmit()">
