...
<title>编辑回复帖子：${single.replyTitle}</title>
...
<center>
<!-- 实现在线编辑回复帖界面 -->
<form action="<%=contextPath%>/visit/reply/c/modifyrun" name="postform" method="post">
...
<table border="0" width="100%" cellspacing="1" cellpadding="2" bgcolor="#999999" style="word-break:break-all">
	<tr class="listhead" height="25"><td colspan="2" style="text-indent:5">编辑回复帖：${single.replyTitle}</td></tr>
	<tr bgcolor="white" height="25">
		<td nowrap>标题：</td>
		<td nowrap><input type="text" name="title" value="${single.replyTitleForEdit}" size="90"></td>
	</tr>
	...
	<tr bgcolor="#F5F5F5">
		...
		<td align="center" nowrap rowspan="4">
			<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center">
						<textarea id="content" name="content">${single.replyContentForJsp}</textarea>
						...
						<input type="button" name="postsubmitb" value="编辑回复" onclick="myoleditsubmit()">
