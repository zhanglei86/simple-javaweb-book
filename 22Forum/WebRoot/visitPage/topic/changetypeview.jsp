...
<!-- 实现修改帖子类型界面 -->
<form action="<%=contextPath%>/visit/topic/c/changetyperun" method="post" name="changeform">
<input type="hidden" name="boardId" value="${single.boardId}">
<input type="hidden" name="topicId" value="${param.topicId}">
<input type="hidden" name="oldtype" value="${single.topicType}">
<table border="0" width="100%" cellspacing="1" cellpadding="2" bgcolor="#999999" style="word-break:break-all">
	...
	<tr bgcolor="lightgrey" align="center">
		<td colspan="2">
			<input type="button" name="editsubmitb" value="修改类型" onclick="myvalidateadminsubmit()">
