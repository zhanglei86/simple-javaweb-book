...
<!-- 实现添加新版主界面 -->
<form action="<%=contextPath%>/admin/board/d/addboardmasterrun" method="post" name="adminform">
...
<table border="0" width="100%" cellspacing="1" cellpadding="2" bgcolor="#999999" style="word-break:break-all">
	<tr class="listhead" height="25"><td colspan="2" style="text-indent:5">添加新版主</td></tr>
	...
	<tr bgcolor="lightgrey" align="center">
		<td colspan="2">
			<input type="button" name="adminsubmitb" value="添加版主" onclick="myaddmastersubmit();">
